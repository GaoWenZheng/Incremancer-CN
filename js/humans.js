...
Police = {
    ...
    populate() {
        ...
        if (this.isExtraPolice()) {
            GameModel.sendMessage("注意:警察活动频繁!");
        }
    },
...
Army = {
    ...
    populate() {
        ...
        if (this.isExtraArmy()) {
            GameModel.sendMessage("注意:军事活动频繁!");
        }
    },
...
Tanks = {
    ...
    populate() {
        ...
        for (var i = 0; i < maxTanks; i++) {
            ...
            tank.tankSprite.anchor = {
                x: 0.5,
                y: 1
            };
            tank.turretSprite.anchor = {
                x: 7.5 / 16,
                y: 7.5 / 16
            };
            tank.tankSprite.x = 0;
